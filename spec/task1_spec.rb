...
describe 'task 1' do
  let(:output_arrs) {[[1, 2, 3, 3, 6, 7, 9, 12, 15, 19], [3, 4, 6, 8, 9, 10, 10, 25, 29], [-5, 4, 6, 6, 8, 8, 9, 10], [1, 3, 6, 7, 15]] }

  describe '#merge' do
    left_arrs = [[1, 3, 6, 7, 15], [6, 8, 10, 25], [4, 6, 8, 10], [1, 3, 6]]
    rigth_arrs = [[2, 3, 9, 12, 19], [3, 4, 9, 10, 29], [-5, 6, 8, 9], [7, 15]]
